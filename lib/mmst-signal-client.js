...
import MMST from './mostly-minimal-spanning-tree.js';
import assert from 'nanocustomassert';
import { Readable } from 'stream';
import { toHex } from './utils';
import { ERR_INVALID_CHANNEL, ERR_MAX_PEERS_REACHED } from './errors';
...
export default class MMSTSignal extends SocketSignalWebsocketClient {
  constructor (opts = {}) {
